...
const Index = () => {
  ...
  return (
    <Container>
      ...
      <Subtitle>Simple & Secure Account Abstraction</Subtitle>
      <CardContainer>
        {state.error && (
          <ErrorMessage>
        ...
        <Card
          content={{
            title: 'Save Data',
            description:
              'Enter any data that you want to be stored securely on the blockchain',
            button: (
              <SaveDataButton
                onClick={handleSaveDataScenario}
        ...
        <Card
          content={{
            title: 'Load Data',
            description:
              'Enter DID of any of your previously saved data on to load',
            button: (
              <LoadDataButton
